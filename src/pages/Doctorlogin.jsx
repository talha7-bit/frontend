...
const Doctorlogin = () => {
  ...
  return (
     ...
     {mshow &&
      ...
      <div className='border px-20 py-10 h-115 xs:w-80 md:w-150 rounded-md flex flex-col items-center justify-center mt-5'>
        <h1 className='text-xl md:text-2xl font-bold text-blue-500'>Login as Doctor</h1>
        ...
        <h1 className='text-sm text-black'>New here?<Link to="/doctorsignup" className='text-blue-500'>signup</Link></h1>
