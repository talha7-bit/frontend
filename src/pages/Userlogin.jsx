  ...
  return (
    ...
    {show && 
     ...
     {mshow &&
      ...
      <div className='border px-20 py-10 h-115 xs:w-80 md:w-150 mt-5 rounded-md flex flex-col items-center justify-center'>
        <h1 className='text-xl md:text-2xl font-bold text-blue-500'>Login as User</h1>
        ...
        <h1 className='text-sm text-black'>New here?<Link to="/usersignup" className='text-blue-500'>signup</Link></h1>

        <Link className='flex mt-26 px-4 py-1 rounded-md text-white bg-blue-500 tracking-tighter w-33'  to="/doctorlogin">Login as Doctor</Link>
      </div>
    </div>
  )
}
